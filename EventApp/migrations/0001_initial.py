    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_coll', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='EventApp.College')),
                ('user_dept', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='EventApp.Department')),
