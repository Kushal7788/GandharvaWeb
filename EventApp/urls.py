...
urlpatterns = [
    ...
    url(r'^team-details/$', views.TeamDetails, name='TeamDetails'),
    ...
    url(r'participant-event-register', views.participantEventRegister, name='participantEventRegister'),
    url(r'participant-details', views.participantDetails, name='participantDetails'),
